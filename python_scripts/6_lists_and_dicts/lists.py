...
# We can add items to the List with an empty index. And the computer will assign the next
# (kinda like AUTOINCREMENT in MySQL)
courseList[] = "GnuMath"  #==> now courseList[3] holds the string "GnuMath"
